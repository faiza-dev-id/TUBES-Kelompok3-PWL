...
<nav class="sidebar">
  ...
  <div class="nav-group">
    ...
    <a href="{{ route('lamaran.saya') }}" class="nav-item"><svg class="nav-icon" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>Lamaran Saya</a>
    ...
    <a href="{{ route('laporan-kegiatan.index') }}" class="nav-item active"><svg class="nav-icon" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M9 17H7A5 5 0 017 7h2"/><path d="M15 7h2a5 5 0 010 10h-2"/><line x1="8" y1="12" x2="16" y2="12"/></svg>Laporan Kegiatan</a>
        ...
        @foreach($laporan as $lap)
          <div class="laporan-item">
            ...
            <div class="lap-actions">
              ...
              @endif
              <a href="{{ route('laporan-kegiatan.download', $lap->id) }}" class="btn-download">⬇ Unduh</a>
              @if($lap->status !== 'diterima')
                <form method="POST" action="{{ route('laporan-kegiatan.destroy', $lap->id) }}" onsubmit="return confirm('Hapus laporan ini?')">
                  @csrf @method('DELETE')
...
<div class="modal-overlay" id="modalUpload">
  <div class="modal">
    ...
    <form method="POST" action="{{ route('laporan-kegiatan.store') }}" enctype="multipart/form-data">
      @csrf
