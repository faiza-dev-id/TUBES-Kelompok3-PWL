...
<nav class="sidebar">
  ...
  <div class="nav-group">
    ...
    <a href="{{ route('lamaran.index') }}" class="nav-item">
    ...
    <a href="{{ route('log.index') }}" class="nav-item active">
                  ...
                  <tr>
                    ...
                    <td>
                      @if($log->status === 'menunggu')
                        <form method="POST" action="{{ route('log.destroy', $log->id) }}" onsubmit="return confirm('Hapus log ini?')">
                          @csrf @method('DELETE')
